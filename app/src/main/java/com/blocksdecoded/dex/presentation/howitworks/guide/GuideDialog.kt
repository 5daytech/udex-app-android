...
class GuideDialog : BaseBottomDialog(R.layout.dialog_guide) {
    ...
    private val pages = listOf(
        GuidePageConfig(R.string.guide_page_1, R.string.guide_page_1_description, R.drawable.img_guide_1),
        GuidePageConfig(R.string.guide_page_2, R.string.guide_page_2_description, R.drawable.img_guide_2),
        GuidePageConfig(R.string.guide_page_3, R.string.guide_page_3_description, R.drawable.img_guide_3)
    )
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        guide_view_pager.adapter = GuidePagerAdapter(childFragmentManager, pages)
