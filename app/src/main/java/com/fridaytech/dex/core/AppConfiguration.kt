...
class AppConfiguration(
    ...
    override val defaultCoinCodes: List<String>
        get() = listOf("ETH", "WETH", "USDC", "ZRX", "DAI", "USDT", "LINK")
    ...
    private val coins = listOf(
        ...
        Coin("Dai", "DAI", CoinType.Erc20("0x6b175474e89094c44da98b954eedeac495271d0f", 18)),
        Coin("Sai", "SAI", CoinType.Erc20("0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359", 18)),
