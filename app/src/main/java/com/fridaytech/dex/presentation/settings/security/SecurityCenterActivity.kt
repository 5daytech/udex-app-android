package com.fridaytech.dex.presentation.settings.security
...
import com.fridaytech.dex.LaunchActivity
import com.fridaytech.dex.R
import com.fridaytech.dex.core.ui.SwipeableActivity
import com.fridaytech.dex.presentation.backup.BackupIntroActivity
import com.fridaytech.dex.presentation.dialogs.AlertDialogFragment
import com.fridaytech.dex.presentation.dialogs.ConfirmActionDialog
...
class SecurityCenterActivity : SwipeableActivity(), ConfirmActionDialog.Listener {
    ...
    private fun initViewModel() {
        ...
        viewModel.openSetPinEvent.observe(this, Observer {
            PinActivity.startForSetPin(this,
        ...
        viewModel.openUnlockPinEvent.observe(this, Observer {
            PinActivity.startForUnlock(this,
                REQUEST_CODE_UNLOCK_PIN_TO_DISABLE_PIN, true)
        })
