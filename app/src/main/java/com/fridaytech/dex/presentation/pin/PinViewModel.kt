...
import com.fridaytech.dex.presentation.pin.PinInteractionType.*
...
import com.fridaytech.dex.presentation.pin.cases.manage.EditPinUseCase
import com.fridaytech.dex.presentation.pin.cases.manage.SetPinUseCase
import com.fridaytech.dex.presentation.pin.cases.unlock.UnlockPinUseCase
...
class PinViewModel : CoreViewModel(), IPinView {
    ...
    val showFingerprintInputEvent =
        SingleLiveEvent<BiometricPrompt.CryptoObject>()
    val resetCirclesWithShakeAndDelayForPageEvent =
        SingleLiveEvent<Int>()
