...
import com.fridaytech.dex.data.security.encryption.CipherWrapper
...
class KeyStoreManager(private val keyAlias: String) : IKeyStoreManager,
    IKeyProvider {
    companion object {
    ...
    private fun validateKey() {
        CipherWrapper(transformationSymmetric)
            .encrypt("abc", getKey())
    }
}
